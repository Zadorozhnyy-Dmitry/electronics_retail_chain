...
class ElectronicsRetailNode(models.Model):
    ...
    name = models.CharField(
        max_length=150, verbose_name="Название", help_text="Введите название звена сети"
    )
    ...
    country = models.CharField(
        max_length=20, verbose_name="Страна", help_text="Введите название страны"
    )
    city = models.CharField(
        max_length=20, verbose_name="Город", help_text="Введите название города"
    )
    street = models.CharField(
        max_length=30, verbose_name="Улица", help_text="Введите название улицы"
    )
    ...
    node_level = models.IntegerField(
        choices=NODE_LEVEL_CHOICES, default=0, verbose_name="Уровень иерархии"
    )
    ...
    def clean(self):
        ...
        if self.supplier and (self.node_level - self.supplier.node_level) != 1:
            raise ValidationError(
                "Собственный уровень иерархии должен быть больше уровня поставщика на единицу"
            )
